...
public class ZMQJavaClient implements Runnable {
    ...
    @Override
    public void run() {
        // let other client examples to run first
        try {
            Thread.sleep(20000);
        ...
        ZMQJavaClient zmqJavaClient = new ZMQJavaClient();
        zmqJavaClient.sendEvents();
    }
